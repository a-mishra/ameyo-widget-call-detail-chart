...
import {callSuccessRate} from './api'
  ...
  if(data == null) {
    ...
    return (
      ...
      <SupervisorDashboardPanel 
        ...
        data={
          <>
            <Chart offered={data.totalOfferedCalls} connected={data.totalConnectedCalls} abandonedIVR={data.totalAbandonedAtIVR} abandonedACD={data.totalAbandonedAtACD}/>
            <ChartOverlay />
          </>
        } 
      />
